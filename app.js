alert('HALOOOOOOOOO LIAAA');
alert("Welcome to 20's");
alert('Selamat hari Milad YAAAAA');
alert('Semoga panjang umur dan sehat selalu');
alert('Dilancarkan Segala Urusannya');
alert('Rezekinya ngalir terus');
alert('Tebak aku siapa');
alert('Aku penunggu kosan kamu');
alert('Coba lihat kebelakang');
alert('WHOAAAAAAAAAAAAAAAAAAA"');
